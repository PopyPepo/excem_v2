<div class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures">
	<div class="nano">
		<div class="nano-content">
			<ul>
				<li class="label">
					<label class="badge badge-primary"><i class="ti-star"></i> Favourite <i class="ti-star"></i></label>
				</li>
				<li class="<?php echo $DOMAIN=='_main' ? 'active' : ''; ?>"><a href="<?php echo $LINK_URL; ?>"><i class="ti-home"></i> Dashboard</a></li>
				...
				<li class="label">
					<label class="badge badge-primary"><i class="ti-star"></i> ข้อมูลงานทุน <i class="ti-star"></i></label>
				</li>
				<li class="<?php echo $DOMAIN=='sch_owner' ? 'active' : ''; ?>">
					<a href="<?php echo $LINK_URL; ?>sch_owner/"><i class="fas fa-landmark"></i> ผู้ให้ทุน</a></li>
				
				<li class="<?php echo $DOMAIN=='sch_discount' ? 'active' : ''; ?>">
					<a href="<?php echo $LINK_URL; ?>sch_discount/"><i class="fab fa-discourse"></i> คิดส่วนลด</a></li>
				
				<li class="<?php echo $DOMAIN=='sch_voucher' ? 'active' : ''; ?>">
					<a href="<?php echo $LINK_URL; ?>sch_voucher/"><i class="fas fa-certificate"></i> ใช้ใบสำคัญ</a></li>
				
				<li class="<?php echo $DOMAIN=='sch_expenses' ? 'active' : ''; ?>">
					<a href="<?php echo $LINK_URL; ?>sch_expenses/"><i class="fas fa-receipt"></i> ค่าใช้จ่าย</a></li>
					
				<li class="<?php echo $DOMAIN=='sch_condition' ? 'active' : ''; ?>">
					<a href="<?php echo $LINK_URL; ?>sch_condition/"><i class="fas fa-balance-scale"></i> เงื่อนไขทุน</a></li>
					
				<?php $scholarship = array("sch_type", "sch_category", "sch_scholarship"); ?>
				<li class="<?php echo in_array($DOMAIN, $scholarship) ? 'active open' : ''; ?>">
					<a class="sidebar-sub-toggle">
						<i class="fas fa-university"></i> ทุนการศึกษา 
						<span class="sidebar-collapse-icon ti-angle-down"></span>
					</a>
					<ul>
						<li class="<?php echo $DOMAIN=='sch_type' ? 'active' : ''; ?>">
							<a href="<?php echo $LINK_URL; ?>sch_type/"> ประเภททุน</a></li>
						<li class="<?php echo $DOMAIN=='sch_category' ? 'active' : ''; ?>">
							<a href="<?php echo $LINK_URL; ?>sch_category/"> หมวดหมู่ทุน</a></li>
						<li class="<?php echo $DOMAIN=='sch_scholarship' ? 'active' : ''; ?>">
							<a href="<?php echo $LINK_URL; ?>sch_scholarship/"> ทุนการศึกษา</a></li>
					</ul>
				</li>
				
				<li class="<?php echo $DOMAIN=='sch_announce' ? 'active' : ''; ?>">
					<a href="<?php echo $LINK_URL; ?>sch_announce/"><i class="fas fa-bullhorn"></i> ประกาศรับสมัคร</a></li>
